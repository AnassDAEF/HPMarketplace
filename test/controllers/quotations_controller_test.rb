...
class QuotationsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create quotation" do
    assert_difference('Quotation.count') do
      post quotations_url, params: { quotation: { cost: @quotation.cost, description: @quotation.description, quantity: @quotation.quantity, task_id: @quotation.task_id, title: @quotation.title } }
    end
  ...
  test "should update quotation" do
    patch quotation_url(@quotation), params: { quotation: { cost: @quotation.cost, description: @quotation.description, quantity: @quotation.quantity, task_id: @quotation.task_id, title: @quotation.title } }
